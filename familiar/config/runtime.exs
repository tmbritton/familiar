...
#
#     PHX_SERVER=true bin/familiar start
#
...
if config_env() == :prod do
  # DATABASE_PATH overrides the FAMILIAR_PROJECT_DIR-based path set above.
  # Optional for CLI usage where FAMILIAR_PROJECT_DIR is already set.
  ...
  # SECRET_KEY_BASE and web endpoint config are only needed when running
  # the Phoenix web server (PHX_SERVER=true). The CLI does not use them.
  if secret_key_base = System.get_env("SECRET_KEY_BASE") do
    host = System.get_env("PHX_HOST") || "example.com"

    config :familiar, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
